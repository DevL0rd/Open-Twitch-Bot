                ...
                if (gameChoice == "Word Game") {
                    ...
                    if (GameType == 1) {
                        if (giveOrTake > 1) {
                            ...
                            say("", "#kohda", "First person to say '" + word + "' wins " + points + " " + options.pointsName + "!", false)
                        } else {

                            say("", "#kohda", "First person to say '" + word + "' loses " + points + " " + options.pointsName + "!", false)
                        }

                    } else if (GameType == 2) {
                        if (giveOrTake > 1) {
                            say("", "#kohda", "First person to say '" + word + "' in reverse wins " + points + " " + options.pointsName + "!", false)

                        } else {
                            say("", "#kohda", "First person to say '" + word + "' in reverse loses " + points + " " + options.pointsName + "!", false)
                        }
                    ...
                    say("", "#kohda", "First person to answer this problem wins " + points + " " + options.pointsName + "! What is '" + mathProblem.replace("-", "minus").replace("+", "plus").replace("*", "times").replace("/", "divided by").replace("^", "to the power of") + ".'", false)
                    ...
                    say("", "#kohda", "Whos '" + randomItem + "' is this? Type 'mine' to claim.", false)
                }
                clearTimeout(gameTimeout)
                gameTimeout = setTimeout(function () {
                    say("", "#kohda", "The game ended without a winner.", false)
                    randomEvent = false
                }, 30000)

...
function init(commands, events, responses, options, viewerDB, display, say, statsDb) {
    ...
    commands.trolls = function (channel, user, message, command, isPrivate) {
        say(user, channel, "!cena (70 " + options.pointsName + "), !say <message> (50 " + options.pointsName + "), !birdup (30 " + options.pointsName + "), !snaildown (30 " + options.pointsName + "), !insult <user> (25 " + options.pointsName + "), !sayinsult <user> (75 " + options.pointsName + "), !godDamn (25 " + options.pointsName + "), !ohShit (25 " + options.pointsName + "), !fullmast (50 " + options.pointsName + "}", isPrivate)
    }
